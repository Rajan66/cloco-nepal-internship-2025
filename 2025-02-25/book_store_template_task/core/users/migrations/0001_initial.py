    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(default=shortuuid.main.ShortUUID.uuid,
                 editable=False, max_length=22, primary_key=True, serialize=False)),
                ...
                ('last_name', models.CharField(default=False,
                 blank=True, verbose_name="last_name")),
                ('phone', models.BooleanField(
                    default=False, verbose_name="phone number")),
